...
- If you want to change database settings, you should modify `config/config.php`,`docker-compose.yml` and `tools/entrypoint.sh` file. Make sure the settings are consistent.
